...
const ProductDetails = () => {
    ...
    // console.log(product)
    const {image,condition,usage,description,title,price_min,price_max,_id,created_at,location,seller_contact,status,seller_image,seller_name} = product;
    ...
    return (
        <div className='w-11/12 mx-auto space-y-6 my-10'>
            {/* top section */}
            <div className='grid grid-cols-1 md:grid-cols-3 gap-3'>
                ...
                <div className='col-span-1 border '>
                    ...
                    <div className='space-y-2 p-4 bg-amber-50 mt-5 border rounded-lg'>
                ...
                {/* right side */}
                <div className=' md:col-span-2 border space-y-4'>
                    <h1 className='text-4xl font-semibold'>{title}</h1>
                    <div className='bg-amber-50 border rounded-lg p-2'>
                    ...
                    <div className='bg-amber-50 border rounded-lg p-2'>
                        ...
                        <p className='text-sm'><span className='font-semibold'>Status:</span> <button className='bg-amber-500 px-2 py-0.5 rounded-xl'>{status}</button> </p>
                    </div>
                    
                    <Link onClick={handleModal} className='btn btn-primary-custom'>I want to buy this product</Link>
